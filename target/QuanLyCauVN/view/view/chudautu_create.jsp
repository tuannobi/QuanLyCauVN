                ...
                <div>
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="date" id="ngaySinh" name="ngaySinh" autocomplete="off" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="soDienThoai">3. Số điện thoại</label><br>
                            <input type="number" id="soDienThoai" name="soDienThoai" autocomplete="off" class="form-control" required>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="email">4. Email</label><br>
                            <input type="email" id="email" name="email"  autocomplete="off" class="form-control" placeholder="Nhập email" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="diaChi">5. Địa chỉ</label><br>
                        <input type="text" id="diaChi" name="diaChi" autocomplete="off" class="form-control" required>
                    </div>
                </div>
