...
<div id="content" style="transition: margin-left .5s;">
    ...
    <div class="table1 container">
        <button type="submit" onclick="window.location.href='user/create'; return false;" class="btn btn-success btn-add"><i class="fal fa-plus-circle"></i> Thêm</button>
        <table id="verticalScroll" class="table table-sm table-bordered table-striped table-hover">
            ...
            <c:forEach var="user" items="${userList}">
                ...
                <tr>
                    ...
                    <td><c:out value="${user.vaiTro.loaiVaiTro}"/></td>
                    <td class="align-center"><a href="${updateLink}"><i class="fad fa-edit"></i></a></td>
<%--                    <td class="delete align-center" id="xoa"><a href="${deleteLink}"><i class="fal fa-times"></i></a></td>--%>
                    <td class="align-center"><i class="fal fa-times delete" id="${user.userId}"></i></td>
                </tr>
            </c:forEach>
            <!-- add row table -->
            </tbody>
        ...
        $(document).on("click",".delete",(event)=>{
            ...
            $("#content").append("<div class='dialog' style='width: 500px;display: none;position: fixed;overflow: hidden;top: 20%;left: 55%;margin-left: -300px;z-index: 99999999;background-color: #fff;padding-bottom: 15px;'>\
                ...
                <div style='display:flex;justify-content: space-evenly;'>\
                    <a href='user/delete?id="+id+"'><button type='button' class='btn btn-secondary' onclick=clickCloseDialog()>Có</button></a>\
