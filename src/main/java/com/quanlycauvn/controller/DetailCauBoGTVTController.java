...
@WebServlet("/bogtvt/detail")
public class DetailCauBoGTVTController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (id > 0) {
            ...
            req.getRequestDispatcher(Constant.Path.urlCauGTVTDetail).forward(req, resp);
        }
    }
}
