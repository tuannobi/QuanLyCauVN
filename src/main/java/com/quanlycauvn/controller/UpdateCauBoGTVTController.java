...
@WebServlet("/bogtvt/update")
public class UpdateCauBoGTVTController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (id > 0) {
            ...
            req.getRequestDispatcher(Constant.Path.urlCauGTVTEdit).forward(req, resp);
        }
    }
