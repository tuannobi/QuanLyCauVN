...
import com.quanlycauvn.util.ExcelExporterFromMySqlBoGTVT;
...
@WebServlet("/bogtvt/exportExcel")
public class ExportExcelIndexCauBoGTVTController extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        User user=(User)req.getSession().getAttribute("user");
        ExcelExporterFromMySqlBoGTVT excelExporterFromMySql=new ExcelExporterFromMySqlBoGTVT(user.getUserId());
