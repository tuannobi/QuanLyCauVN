...
<%--        <button type="button" onclick="window.location.href='bridge/create'; return false;" class="btn btn-success btn-add"><i class="fal fa-plus-circle"></i> Thêm</button>--%>
<%--        <button type="button" onclick="window.location.href='bridge/exportExcel'; return false;" class="btn btn-danger btn-add text-white"><i class="fad fa-file-export"></i> Xuất Excel</button>--%>
...
<%--                        <c:url var="updateLink" value="bridge/update">--%>
<%--                            <c:param name="id" value="${item.soThuTu}" />--%>
<%--                        </c:url>--%>
                        <c:url var="detailLink" value="nhanvien/detail">
                            <c:param name="id" value="${item.soThuTu}" />
                        </c:url>
                        <tr>
